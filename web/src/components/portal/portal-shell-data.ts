    ...
    },
    {
      ...
      items: [
        ...
        portalItem({
          href: "/corujao",
          label: "Corujão",
          description: "Gestao de clientes e sessoes do Corujao",
          icon: MoonIcon,
          kind: "page",
          keywords: ["corujao", "clientes", "sessoes", "presencas", "evento"],
          children: [
            portalItem({
              href: "/corujao",
              label: "Clientes",
              description: "Clientes cadastrados no Corujao",
              icon: UsersIcon,
              kind: "resource",
              keywords: ["clientes", "corujao", "presenca"],
            }),
            portalItem({
              href: "/corujao/sessoes",
              label: "Sessões",
              description: "Sessoes e controle de presenca",
              icon: MoonIcon,
              kind: "resource",
              keywords: ["sessoes", "presencas", "corujao", "data"],
            }),
          ],
        }),
        portalItem({
